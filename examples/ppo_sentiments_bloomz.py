...
model_path="bigscience/bigscience-small-testing"
...
default_config = TRLConfig(
    ...
    tokenizer=TokenizerConfig(
        ...
        #tokenizer_path="bigscience/bloomz-1b1",
...
def main(hparams={}):
    ...
    prompts = prompts[0:100]
    val_prompts = build_imdb_dataset_test(tokenizer)["query"][0:10]
